...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">SNK-HomeStayS</a>
    ...
    <div class="container-fluid px-lg-4 mt-4 ">
        ...
        <div class="swiper-wrapper">
            ...
            <img src="Pictures/slides/1.jpg" class="w-100 d-block" height="350px;"/>
            </div>
            <div class="swiper-slide">
            <img src="Pictures/slides/2.jpg" class="w-100 d-block" height="350px;"/>
            </div>
            <div class="swiper-slide">
            <img src="Pictures/slides/3.jpg" class="w-100 d-block" height="350px;"/>
            </div>
            <div class="swiper-slide">
            <img src="Pictures/slides/4.jpg" class="w-100 d-block" height="350px;"/>
            </div>
        </div>
        </div>
    </div>
