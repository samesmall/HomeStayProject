...
<head>
    ...
    <title>Fresh HomeStay - ROOM DETAILS</title>
                        ...
                        <?php 
                           ...
                           rating;
                            ...
                            if(!$settings_r['shutdown']){
                                ...
                                echo<<<book
                                <button onclick='checkLoginToBook($login,$room_data[id])' class="btn btn-sm w-100 text-white custom-bg shadow-none mb-1">Book Now</button>
                                book;
                            }
